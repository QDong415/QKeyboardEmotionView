...
@interface QPlaceHolderTextView ()

@property(nonatomic, strong) UILabel *placeholderLabel;

@end

@implementation QPlaceHolderTextView
...
- (void)handleTextChanged:(id)sender {
    QPlaceHolderTextView *textView = nil;
    if ([sender isKindOfClass:[NSNotification class]]) {
        id object = ((NSNotification *)sender).object;
        if (object == self) {
            textView = (QPlaceHolderTextView *)object;
        }
    } else if ([sender isKindOfClass:[QPlaceHolderTextView class]]) {
        textView = (QPlaceHolderTextView *)sender;
    }
